// MotorControlTesterSA.cpp : Defines the entry point for the console application.
//
...
#include "MotorControlTesterSA.hpp"


static const char MODULENAME[] = "MotorControlTesterSA";
